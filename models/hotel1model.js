...
const userSchema = new mongoose.Schema({
  ...
  arrivalFrom: { type: String, required: true, unique: false },
  departTo: { type: String, required: true, unique: false },
...
const hotel1UsersDetails = mongoose.model(
  "hotel1_data",
  userSchema
);
export default hotel1UsersDetails;
